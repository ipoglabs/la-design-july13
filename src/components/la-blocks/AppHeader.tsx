...
export default function AppHeader({ variant = "default", user = null }: AppHeaderProps) {
  ...
  // Derive effective variant from current pathname — this updates on every
  // client-side soft navigation (usePathname is reactive), so the header
  // always reflects the correct state regardless of what the server rendered.
