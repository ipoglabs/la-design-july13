...
import { useVehicleConfig } from "@/lib/hooks/useVehicleConfig";
...
export default function VanForm() {
  ...
  const dispatchValidated = (ok: boolean) => {
    ...
    window.dispatchEvent(new CustomEvent("vanform:validated", { detail: { ok } }));
  };
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <FormField label="Seating Capacity" field="seatingCapacity" type="number" value={seatingCapacity} onChange={(v) => setField("seatingCapacity", v)} />
      </div>
      ...
      <div className="space-y-1">
        ...
        <input
          ...
          placeholder="e.g. Reverse Camera, Cruise Control"
        />
      </div>
