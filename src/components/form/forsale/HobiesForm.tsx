...
export default function HobbiesCollectionsForm() {
  ...
  useEffect(() => {
    ...
    if (!subcategory) setField("subcategory", "Hobbies & Collections");
  ...
  const dispatchValidated = (ok: boolean) => {
    ...
    window.dispatchEvent(new CustomEvent("hobbiesform:validated", { detail: { ok } }));
  };
  ...
  return (
    ...
    >
      ...
      <ToggleButtonGroup title="Item Type" singleSelect value={itemType ? [itemType] : []} onChange={(v) => setField("itemType", v[0] ?? "")}>
        ...
        <ToggleGroupButton value="antiques">Antiques</ToggleGroupButton>
        <ToggleGroupButton value="books">Books &amp; Comics</ToggleGroupButton>
        <ToggleGroupButton value="musical">Musical Instruments</ToggleGroupButton>
        <ToggleGroupButton value="stamps">Stamps &amp; Coins</ToggleGroupButton>
        <ToggleGroupButton value="sports">Sports Memorabilia</ToggleGroupButton>
        <ToggleGroupButton value="other">Other Collectibles</ToggleGroupButton>
      </ToggleButtonGroup>
      ...
      <ToggleButtonGroup title="Condition" singleSelect value={condition ? [condition] : []} onChange={(v) => setField("condition", v[0] ?? "")}>
        ...
        <ToggleGroupButton value="vintage">Vintage</ToggleGroupButton>
      </ToggleButtonGroup>
